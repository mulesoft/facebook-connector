...
/**
 * GetEventMessageProcessor invokes the {@link org.mule.module.facebook.FacebookConnector#getEvent(java.lang.String, java.lang.String)} method in {@link FacebookConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public GetEventMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedMetadata = ((String) evaluateAndTransform(getMuleContext(), event, GetEventMessageProcessor.class.getDeclaredField("_metadataType").getGenericType(), null, metadata));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((FacebookConnector) object).getEvent(_transformedEventId, _transformedMetadata);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at FacebookConnector at getEvent retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
