    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public PublishNoteMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedProfile_id = ((String) evaluateAndTransform(getMuleContext(), event, PublishNoteMessageProcessor.class.getDeclaredField("_profile_idType").getGenericType(), null, profile_id));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((FacebookConnector) object).publishNote(_transformedProfile_id, _transformedMsg, _transformedSubject);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at FacebookConnector at publishNote retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
